...
/** @deprecated Use {@link localizeErrorResponse}. */
export const resolveApiError = localizeErrorResponse;
...
/** @deprecated Use {@link localizeErrorFromResponse}. */
export const resolveApiErrorFromResponse = localizeErrorFromResponse;
